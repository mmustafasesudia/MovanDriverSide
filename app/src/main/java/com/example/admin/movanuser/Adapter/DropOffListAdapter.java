...
public class DropOffListAdapter extends BaseAdapter {

    private static LayoutInflater inflater = null;
    Context context;
    ArrayList<Pickupqueue> data;

    public DropOffListAdapter(Activity mainActivity, ArrayList<Pickupqueue> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.custom_list_item_layout2, null);
        holder.name = rowView.findViewById(R.id.dropoffname);
        holder.phone_number = rowView.findViewById(R.id.dropoffphonno);
        holder.iv_navigation = rowView.findViewById(R.id.iv_dropoff);
        holder.iv_navigation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String droplat = current.getDrop_lat();
                String droplng = current.getDrop_long();
