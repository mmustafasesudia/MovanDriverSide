...
import com.example.admin.movanuser.Map_support.AppUtils;
import com.example.admin.movanuser.Map_support.FetchAddressIntentService;
...
public class ChooseLocation extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationAddress = findViewById(R.id.Address);
        mLocationText = findViewById(R.id.Locality);
        confirm = findViewById(R.id.confirm);
        tv_timer = findViewById(R.id.tv_timer);
        fl = findViewById(R.id.layout_frame);
