...
import com.example.admin.movanuser.ChooseLocation;
...
//        }
   ...
   /* @Override
    ...
    public void sendData() {
        ...
        AndroidNetworking.post(ConfigURL.URL_CREATE_JOURNEY)
                .addBodyParameter("van_num", ConfigURL.getVanNo(getActivity()))
                .addBodyParameter("driver_mobile_num", ConfigURL.getMobileNo(getActivity()))
                .addBodyParameter("src_lat", ConfigURL.PICK_UP_LAT)
                .addBodyParameter("src_long", ConfigURL.PICK_UP_LNG)
                .addBodyParameter("dest_lat", ConfigURL.DROP_OF_LAT)
                .addBodyParameter("dest_long", ConfigURL.DROP_OF_LNG)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            Log.d("jhjkk", "res: " + response);

                            if (!response.getBoolean("error")) {

                                Log.d("jhjkk", "res: " + response);
                                String Journy_id = response.getString("Journy_id");
                                Bundle args = new Bundle();
                                args.putString("Journy_id", Journy_id);
                                ...
                                Toast.makeText(getActivity(), "Journey not created", Toast.LENGTH_LONG).show();
                            }
