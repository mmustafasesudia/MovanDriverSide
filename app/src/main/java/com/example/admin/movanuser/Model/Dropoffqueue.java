...
public class Dropoffqueue {
    ...
    public Dropoffqueue(String person_name, String person_mobileNo, String customer_status, String pick_lat, String pick_long, String drop_lat, String drop_long, String fare) {
